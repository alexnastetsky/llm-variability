...
- `kv_store_ops([['SET', 'a', 1], ['BEGIN'], ['SET', 'a', 2], ['GET', 'a'], ['ROLLBACK'], ['GET', 'a']])` → `[2, 'OK', 1]`
- `kv_store_ops([['ROLLBACK']])` → `['NO TRANSACTION']`
- `kv_store_ops([['SET', 'a', 1], ['BEGIN'], ['SET', 'b', 2], ['BEGIN'], ['DELETE', 'a'], ['COUNT', 1], ['ROLLBACK'], ['COUNT', 1], ['COMMIT']])` → `[0, 'OK', 1, 'OK']`
- `kv_store_ops([['SET', 'a', True]])` raises `ValueError`
