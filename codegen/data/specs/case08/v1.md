...
- `kv_store_ops([['SET', 'a', 1], ['GET', 'a']])` → `[1]`
- `kv_store_ops([['SET', 'a', 1], ['BEGIN'], ['DELETE', 'a'], ['GET', 'a'], ['COMMIT'], ['GET', 'a']])` → `['NULL', 'OK', 'NULL']`
- `kv_store_ops([['BEGIN'], ['SET', 'a', 5], ['BEGIN'], ['SET', 'a', 6], ['COMMIT'], ['GET', 'a']])` → `['OK', 6]`
- `kv_store_ops([['BEGIN'], ['BEGIN'], ['SET', 'a', 1], ['COMMIT'], ['GET', 'a'], ['ROLLBACK']])` → `['OK', 1, 'NO TRANSACTION']`
